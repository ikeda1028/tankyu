...
const publicFiles = ["index.html", "styles.css", "app.js", "database.js", "firebase-sync.js", "ar-dragon.html", "model-world.html", "world-access.js", "mentor-progression.js"];
const assetFiles = ["opening-kids.mp4", "fudozaka-dragon.glb", "fudo.glb", "fudozaka-dragon-poster.png", "MANABI_Shibuya_3F.glb", "account.svg", "close.svg", "lucide-LICENSE"];
...
async function readSourcePublicConfig() {
  try {
    ...
    return context.window.WAKUWAKU_CONFIG && typeof context.window.WAKUWAKU_CONFIG === "object" ? context.window.WAKUWAKU_CONFIG : {};
  } catch { return {}; }
}

function fallbackEnv(value, fallback = "") { return value || String(fallback || "").trim(); }
...
const config = {
  ...
  firebase: {
    ...
    storageBucket: fallbackEnv(firebaseJson.storageBucket || getEnv("FIREBASE_STORAGE_BUCKET", "PUBLIC_FIREBASE_STORAGE_BUCKET"), sourceFirebase.storageBucket),
    messagingSenderId: fallbackEnv(firebaseJson.messagingSenderId || getEnv("FIREBASE_MESSAGING_SENDER_ID", "PUBLIC_FIREBASE_MESSAGING_SENDER_ID"), sourceFirebase.messagingSenderId),
  ...
  features: {
    ...
    googleMaps: Boolean(getEnv("GOOGLE_MAPS_API_KEY", "PUBLIC_GOOGLE_MAPS_API_KEY", "NEXT_PUBLIC_GOOGLE_MAPS_API_KEY") || sourceConfig.googleMapsApiKey),
